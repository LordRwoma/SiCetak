...
<section class="chatbot-section">
    <div class="chatbot-container">
        ...
        <div class="chatbot-content">
            ...
            <button class="btn btn-primary" onclick="masukDashboard()">Mulai Chat</button>
        </div>
    </div>
</section>
...
<section class="testimonial-section">
    <div class="testimonial-container">
        ...
        <h2 class="section-title">Apa Kata Mereka Tentang <span class="section-highlight">SiRoma?</span></h2>
        <p class="section-description">Menurut kami dari pandangan mata orang tentang pengalaman penggunaan SiRoma</p>
        
        <div class="testimonial-slider">
            <div class="testimonial-card">
                <div class="quote-icon">"</div>
                <p class="testimonial-text">
                    Layanan sibok jadie membantu banget atas penjelasan yang diberikan. aplikasi yang mudah digunakan, dari segi user interface dan user experience juga friendly.
                </p>
